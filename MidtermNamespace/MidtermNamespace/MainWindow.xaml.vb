Imports MidtermNamespace.Display
Imports MidtermNamespace.Assign
...
Class MainWindow
    ...
    Private Sub btnFind_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnFind.Click
        ...
        Output.OutputNull(phoneName)
        Output.OutputNull(phoneDesc)

        Dim phoneID As String = modelBox.Text

        If phones.ContainsKey(phoneID) Then
            Output.OutputName(phoneName, phoneID)
            Output.OutputDesc(phoneDesc, phones.Item(phoneID))
        Else
            Output.OutputDesc(phoneDesc, "Item not found.")
        End If
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnAdd.Click
        ...
        Store.AddDict(phones, phoneID, phoneSpecs)
    ...
    Private Sub btnDel_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnDel.Click
        ...
        If phones.ContainsKey(phoneID) Then
            ...
            Output.OutputNull(phoneName)
            Output.OutputNull(phoneDesc)
            Output.OutputDesc(phoneDesc, "Item removed.")
        Else
            Output.OutputDesc(phoneDesc, "Item not found.")
        End If
        ...
        If phoneList.SelectedIndex <> -1 Then
            If phoneList.SelectedItem.ToString <> "" Then
                If phones.ContainsKey(phoneList.SelectedItem.ToString) Then
                    Output.OutputNull(phoneName)
                    Output.OutputNull(phoneDesc)
                    Output.OutputName(phoneName, phoneList.SelectedItem.ToString)
                    Output.OutputDesc(phoneDesc, phones.Item(phoneList.SelectedItem.ToString))
                End If
            End If
        End If
    ...
    Private Sub phoneList_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles phoneList.Loaded
        ...
        If ctr = 1 Then
            ...
            Store.AddDict(phones, phoneID1, phoneSpecs1)
            Store.AddDict(phones, phoneID2, phoneSpecs2)
            Store.AddDict(phones, phoneID3, phoneSpecs3)
            Store.AddDict(phones, phoneID4, phoneSpecs4)
            Store.AddDict(phones, phoneID5, phoneSpecs5)

            Store.AddItem(phoneList, phoneID1)
            Store.AddItem(phoneList, phoneID2)
            Store.AddItem(phoneList, phoneID3)
            Store.AddItem(phoneList, phoneID4)
            Store.AddItem(phoneList, phoneID5)
